...
Vehicle owners, known as the **RENTER**, also need a simple way to add their vehicles for renting services, and manage them when they are available for rent. 

At the same time, the person managing the rental service, known as the **ADMIN**, needs to keep track of users, and vehicles, verify payment, and rental records.
...
## Purpose
The main purpose of this system is to provide a simple and organized way to manage vehicle owners, customers, vehicles, rentals, and bills while reducing manual work and keeping rental information easy to access.
